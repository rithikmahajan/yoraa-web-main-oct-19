...
const ReturnOrder = () => {
  ...
  <path opacity="0.1" d="M31 62C48.1208 62 62 48.1208 62 31C62 13.8792 48.1208 0 31 0C13.8792 0 0 13.8792 0 31C0 48.1208 13.8792 62 31 62Z" fill="#EA4335"/>
  <path d="M30.6677 9.9502C19.2245 9.9502 9.9375 19.2372 9.9375 30.6804C9.9375 42.1236 19.2245 51.4106 30.6677 51.4106C42.1109 51.4106 51.3979 42.1236 51.3979 30.6804C51.3979 19.2372 42.1109 9.9502 30.6677 9.9502Z" fill="#EA4335"/>
  <path d="M30.6094 22.1973V33.717" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M30.7969 38.4346H30.8079" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
          </div>
          ...
          <div className="text-gray-600 mb-10 leading-relaxed">
            <p className="text-sm mb-2">Please note that Rs. 200 reverse shipment charges are</p>
            <p className="text-sm mb-2">applicable. Charges vary for International Delivery Please</p>
            <p className="text-sm">read our return and exchange policies before proceeding.</p>
          </div>
          
          <div className="flex space-x-3">
            <button 
              onClick={() => setCurrentStep(1)}
              className="flex-1 bg-black text-white py-3 px-4 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors"
            >
              Go Back
            </button>
            <button 
              onClick={() => setCurrentStep(3)}
              className="flex-1 bg-white border border-gray-300 text-gray-900 py-3 px-4 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors"
            >
              Request Return
            </button>
          </div>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M53.7878 30.5401C54.4008 31.1547 54.4008 32.1513 53.7878 32.7649L36.5258 50.0733C35.9128 50.6879 34.9198 50.6879 34.3068 50.0733L26.4597 42.2057C25.8468 41.5911 25.8468 40.5955 26.4597 39.9808C27.0727 39.3662 28.0668 39.3662 28.6788 39.9808L35.4157 46.7356L51.5688 30.5401C52.1818 29.9254 53.1758 29.9254 53.7878 30.5401Z" fill="white"/>
          ...
          <h1 className="text-xl font-semibold text-gray-900 mb-6">
            Thank you for requesting return!
          </h1>
          
          <div className="text-gray-600 mb-10 leading-relaxed">
            <p className="text-sm mb-2">We appreciated your feedback.</p>
            <p className="text-sm mb-2">We'll use your feedback to improve</p>
            <p className="text-sm">your experience.</p>
          </div>
  ...
  return (
    <div className="min-h-screen">
      ...
      {currentStep === 2 && <RequestingReturnPage />}
      {currentStep === 3 && <ThankYouPage />}
